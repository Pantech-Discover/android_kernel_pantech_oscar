...
#if 0
static struct i2c_board_info yacd5c1sbdbc_eeprom_i2c_info = {
	I2C_BOARD_INFO("yacd5c1sbdbc_eeprom", 0x34 << 1),//?
};

static struct msm_eeprom_info yacd5c1sbdbc_eeprom_info = {
	.board_info     = &yacd5c1sbdbc_eeprom_i2c_info,
	.bus_id         = MSM_8960_GSBI4_QUP_I2C_BUS_ID,
};
#endif
